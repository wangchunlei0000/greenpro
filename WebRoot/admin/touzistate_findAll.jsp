...
<html>
  ...
  <center>
  	<form action="touzistate_add.action" method="post">
	  <br/><br/><br/><br/>
	  	<h2><font color="#3CB371">新增投资状态</font></h2>
	  	<br/>
	  ...
	  <hr/>
  	<div align="center">
	    <h2><font color="#3CB371">投资状态</font></h2>
	    <table  id="customers" width="40%" width="40%" border="1" style="text-align:center">
	    	...
	    	<s:iterator value="li" var="opp">
	   		<tr>
	   			...
	   			<td><a href="touzistate_toupdate.action?o.id=${opp.id}">修改</a></td>
	   			<td class="alt"><a href="touzistate_todelete.action?o.id=${opp.id}" onclick="return confirm('确定删除?');">删除</a></td>
	   		</tr>
	    	</s:iterator>
	    </table>
    </div>
