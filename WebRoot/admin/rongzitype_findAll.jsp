...
<html>
  ...
  <center>
  	<form action="rongzitype_add.action" method="post">
	  <br/><br/><br/><br/>
	  	<h2><font color="#3CB371">新增融资类型</font></h2>
	  	<br/>
	  ...
	  <hr/>
  	<div align="center">
	    <h2><font color="#3CB371">融资类型</font></h2>
	    <table  id="customers" width="40%" width="40%" border="1" style="text-align:center">
	    	...
	    	<s:iterator value="lis" var="op">
	   		<tr>
	   			...
	   			<td><a href="rongzitype_toupdate.action?o.id=${op.id}">修改</a></td>
	   			<td class="alt"><a href="rongzitype_todelete.action?o.id=${op.id}" onclick="return confirm('确定删除?');">删除</a></td>
	   		</tr>
	    	</s:iterator>
	    </table>
    </div>
