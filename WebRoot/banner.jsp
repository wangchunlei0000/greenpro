				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-13" id="cl-effect-13">
						<ul class="nav navbar-nav">
							...
							<li><a href="findAllPoj.jsp">融资项目</a></li>
							<li><a href="findTAllPoj.jsp">投资项目</a></li>
							<li><a href="news_yfindAll.action">浏览资讯</a></li>
							<li>
							<s:if test='(#session.userid)==null'><a href="logins.jsp">登录</a></s:if>
							<s:else><a href="user/user_index.jsp">用户中心</a></s:else>
							</li>
							<li><a href="tuichu.action">退出登录</a></li>
						</ul>
					</nav
				</div>	
				<div class="search">
