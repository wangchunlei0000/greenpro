 ...
 .zhubu{
  ...
  <body>
    ...
    <a class="zhubu" href="javascript:history.go(-1)">确定</a>&nbsp;&nbsp;
  	<!-- <a class="zhubu" href="cytpoj_users.action?po.pojid=${p.pojid}">查看融资状况</a> -->
  
       	<s:if test="(p.touziState.id)==2">
       	   	<s:if test="%{p.users.userid.equals(#session.userid)}">
<button  class="zhubu" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">查看投资状态</button>
...
<div id="id01" class="modal">
  ...
  <div class="modal-content animate" style="height=500px;">
  
    <h2 style="color:white">参与项目-${p.name}投资的用户</h2><br/>
      <table style="border: 1px solid rgb(224, 224, 224); background: black none repeat scroll 0% 0%; font-size: 1.2em; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;" width="828" >
    	<tr>
    		...
    		<th style="border:1px solid #e0e0e0; color:white">投资金额</th>
