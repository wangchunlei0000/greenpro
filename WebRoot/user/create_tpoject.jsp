...
input[type=text], input[type=password] {
  ...
  function   action1()      
  {      
        document.form1.action="touzipoj_zancun.action";      
  ...
  <body>
<br/><br/>
    <form name="form1" id="form1" action="touzipoj_save.action?u.userid=${session.userid}" enctype="multipart/form-data" method="post"><center>
    <table class="yy" width="429" height="646">
    	...
    	<tr><td>目标金额</td><td><input type="text" name="p.money" value="${p.name}" onkeyup="clearNoNum(this)"/></td></tr>
