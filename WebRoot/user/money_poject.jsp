...
.zhubu{
 ...
 .errorMessage li {  
  ...
  <body><div style="height:5%"><jsp:include page="/banner.jsp"></jsp:include>
    ...
    <form action="up_nowmoney.action?p.pojid=${p.pojid}&u.userid=${session.userid}" method="post"> 
    	融资金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="rzmoney" onkeyup="clearNoNum(this)"/>
    		   <input class="zhubu" type="submit" value="确定"/>
    		   <s:fielderror theme="simple"  fieldName="rzmoney"></s:fielderror>
    		   <br/><br/>
    		   <a href="y_yfindByTitle.action?p.name=&r1.id=&r2.id" class="zhubu"><span>返回</span></a>
    </form>
