...
public class TouziPojDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TouziPojDAO.class);
	// property constants
	...
	public int getRowByTitle(String userid,String name, Integer id, Integer id2) {
		try{
			...
			sb.append("select count(*) from TouziPoj where users.userid='"+userid+"'");
			System.out.println(sb.toString());
			if(!"".equals(name)&name!=null) sb.append(" and name like '%"+name+"%'");System.out.println(sb.toString());
			if(!"".equals(id)&id!=null) sb.append(" and touziState.id="+id);System.out.println(sb.toString());
			if(!"".equals(id2)&id2!=null) sb.append(" and touziType.id="+id2);System.out.println(sb.toString());
	...
	public List findAllByTitle(Integer currentPage, Integer  pageSize,String userid,String name, Integer id, Integer id2){
    	...
    	try{
			StringBuffer sb = new StringBuffer();
			sb.append("from TouziPoj where users.userid='"+userid+"'");
			if(!"".equals(name)&name!=null) sb.append(" and name like '%"+name+"%'");
			if(!"".equals(id)&id!=null) sb.append(" and touziState.id="+id);
			if(!"".equals(id2)&id2!=null) sb.append(" and touziType.id="+id2);
			String queryString = sb.toString();
	...
	public TouziPoj findById(java.lang.Integer id) {
		log.debug("getting TouziPoj instance with id: " + id);
		try {
			TouziPoj instance = (TouziPoj) getSession().get(
					"org.g.pojo.TouziPoj", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TouziPoj instance) {
		log.debug("finding TouziPoj instance by example");
		try {
			List results = getSession().createCriteria("org.g.pojo.TouziPoj")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TouziPoj instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from TouziPoj as model where model."
					+ propertyName + "= ?";
			Query queryObject = getSession().createQuery(queryString);
	...
	//����Ա�鿴������Ŀ
	public List findAll() {
		log.debug("finding all TouziPoj instances");
		try {
			String queryString = "from TouziPoj";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public List findAlljb() {
		log.debug("finding all TouziPoj instances");
		try {
			String queryString = "from TouziPoj where touziState.id=6";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
			log.error("find all failed", re);
	...
	public List findAllByUser(String userid) {
		log.debug("finding all TouziPoj instances");
		try {
			String queryString = "from TouziPoj where users.userid='"+userid+"'";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
			log.error("find all failed", re);
	...
	@SuppressWarnings("finally")
	public boolean merge(TouziPoj p) {
	...
	public void attachDirty(TouziPoj instance) {
		log.debug("attaching dirty TouziPoj instance");
		try {
	...
	public void attachClean(TouziPoj instance) {
		log.debug("attaching clean TouziPoj instance");
		try {
...
// �ο� �鿴����Ŀ �����С����ʽ���
	public List findAllPoj() {
		log.debug("finding all TouziPoj instances");
		try {
			System.out.println("TouziPojDAO.findAllPoj");
			String queryString = "from TouziPoj where touziState.id !=5 and touziState.id !=8";
	...
	public List daishen() {
		try {
			System.out.println("TouziPojDAO.daishen");
			String queryString = "from TouziPoj where touziState.id=1";
			System.out.println("DAO.begin");
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public int getyRowByTitle(String name, Integer id, Integer id2) {
		try{
			...
			sb.append("select count(*) from TouziPoj where touziState.id in (2,4)");
			if(!"".equals(name)&name!=null) {sb.append(" and name like '%"+name+"%'");}
			if(id!=null&!"".equals(id)){sb.append(" and touziState.id="+id);}
			if(id2!=null&!"".equals(id2)){sb.append(" and touziType.id="+id2);}
			String queryString = sb.toString();
	...
	public List yfindAllByTitle(Integer currentPage, Integer  pageSize,String name, Integer id, Integer id2){
    	...
    	try{
			StringBuffer sb = new StringBuffer();
			sb.append("from TouziPoj where touziState.id in (2,4)");
			if(!"".equals(name)&name!=null) {sb.append(" and name like '%"+name+"%'");}
			if(id!=null&!"".equals(id)){sb.append(" and touziState.id="+id);}
			if(id2!=null&!"".equals(id2)){sb.append(" and touziType.id="+id2);}
			String queryString = sb.toString();
	...
	public List jubao() {
		try {
			System.out.println("TouziPojDAO.jubao");
			String queryString = "from TouziPoj where touziState.id=8";
			System.out.println("DAO.begin");
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public List findAllstate(){
		try {
			...
			String queryString = "from TouziPoj where touziState.id=2";
			System.out.println("DAO.begin");
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public int getadRowByTitle(String name, Integer id, Integer id2) {
		try{
			StringBuffer sb = new StringBuffer();
			System.out.println("DAO  row"+name);
			sb.append("select count(*) from TouziPoj where touziState.id!=9");
			if(!"".equals(name)&name!=null) {sb.append(" and name like '%"+name+"%'");}
			if(id!=null&!"".equals(id)){sb.append(" and touziState.id="+id);}
	...
	public List adfindAllByTitle(Integer currentPage, Integer  pageSize,String name, Integer id, Integer id2){
    	...
    	try{
			StringBuffer sb = new StringBuffer();
			sb.append("from TouziPoj where  touziState.id!=9");
			if(!"".equals(name)&name!=null) {sb.append(" and name like '%"+name+"%'");}
			if(id!=null&!"".equals(id)){sb.append(" and touziState.id="+id);}
			if(id2!=null&!"".equals(id2)){sb.append(" and touziType.id="+id2);}
			String queryString = sb.toString();
